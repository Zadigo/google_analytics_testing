...
urlpatterns = [
    ...
    re_path(r'^customer-orders$', views.CustomerOrdersView.as_view(),
            name='customer_orders'),
    re_path(r'^checkout/success$', views.PaymentSuccessView.as_view(),
            name='payment_sucess'),
    re_path(r'^checkout/payment$', views.PaymentView.as_view(), name='payment'),
    re_path(r'^checkout/shipping$',
            views.ShippingView.as_view(), name='shipping'),
